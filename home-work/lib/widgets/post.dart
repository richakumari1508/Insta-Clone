...
import 'package:home_work/pages/comments.dart';
import 'package:home_work/pages/home.dart';
import 'package:home_work/widgets/custom_image.dart';
     ...
     final String location;
      final String description;
       final String mediaUrl;
        ...
        addLikeToActivityFeed(){
          //add  notification to the postOwner's activity feed only if comment made by other user
